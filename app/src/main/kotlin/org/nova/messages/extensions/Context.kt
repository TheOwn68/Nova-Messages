...
import org.nova.messages.databases.MessagesDatabase
import org.nova.messages.helpers.AttachmentUtils.parseAttachmentNames
import org.nova.messages.helpers.Config
import org.nova.messages.helpers.FILE_SIZE_NONE
import org.nova.messages.helpers.MAX_MESSAGE_LENGTH
import org.nova.messages.helpers.MESSAGES_LIMIT
import org.nova.messages.helpers.MessagingCache
import org.nova.messages.helpers.NotificationHelper
import org.nova.messages.helpers.NovaCrypto
import org.nova.messages.helpers.ShortcutHelper
import org.nova.messages.helpers.generateRandomId
import org.nova.messages.helpers.THREAD_RECEIVED_MESSAGE
import org.nova.messages.helpers.THREAD_SENT_MESSAGE
import org.nova.messages.interfaces.AttachmentsDao
import org.nova.messages.interfaces.ConversationsDao
...
import org.nova.messages.messaging.scheduleMessage
        ...
        if (unwrapped != null) {
            ...
            if (conversation != null) {
                try {
                    ...
                    android.util.Log.e("Context", "Decryption failed for msg $id", e)
                }
            }
        } else if (body.endsWith("\u200B")) {
            finalBody = body.removeSuffix("\u200B")
        }
        ...
        if (unwrapped != null) {
            ...
            if (conversation != null) {
                try {
                    ...
                    android.util.Log.e("Context", "Decryption failed for MMS $mmsId", e)
                }
            }
        } else if (body.endsWith("\u200B")) {
            finalBody = body.removeSuffix("\u200B")
...
fun Context.createTemporaryThread(
    ...
    val conversation = Conversation(
        ...
        isArchived = false,
        unreadCount = 0,
        isNovaUser = cachedConv?.isNovaUser == true,
        novaSharedSecret = cachedConv?.novaSharedSecret,
    )
    try {
